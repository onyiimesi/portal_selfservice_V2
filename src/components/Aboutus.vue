...
<template>
  <div class="content-wrapper">
      ...
      <div class="container pt-17 pb-23 pt-md-19 pb-md-24 text-center">
        <div class="row">
          <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6 mx-auto">
            <h1 class="display-1 mb-3 text-white">About Us</h1>
            <nav class="d-inline-block" aria-label="breadcrumb">
              <ol class="breadcrumb text-white">
                <li class="breadcrumb-item"><RouterLink @click="removeItem" to="/">Home</RouterLink></li>
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-6 mb-10 align-items-center">
          <div class="col-lg-6 order-lg-2">
            <ul class="progress-list">
              <li>
                <p>Marketing</p>
                <div class="progressbar line blue" data-value="100"><svg viewBox="0 0 100 6" preserveAspectRatio="none" style="display: block; width: 100%;"><path d="M 0,3 L 100,3" stroke="#eee" stroke-width="6" fill-opacity="0"></path><path d="M 0,3 L 100,3" stroke="#555" stroke-width="6" fill-opacity="0" style="stroke-dasharray: 100, 100; stroke-dashoffset: 0;"></path></svg><div class="progressbar-text" style="color: inherit; position: absolute; right: 0px; top: -30px; padding: 0px; margin: 0px;">100 %</div></div>
              </li>
              <li>
                <p>Strategy</p>
                <div class="progressbar line green" data-value="80"><svg viewBox="0 0 100 6" preserveAspectRatio="none" style="display: block; width: 100%;"><path d="M 0,3 L 100,3" stroke="#eee" stroke-width="6" fill-opacity="0"></path><path d="M 0,3 L 100,3" stroke="#555" stroke-width="6" fill-opacity="0" style="stroke-dasharray: 100, 100; stroke-dashoffset: 20;"></path></svg><div class="progressbar-text" style="color: inherit; position: absolute; right: 0px; top: -30px; padding: 0px; margin: 0px;">80 %</div></div>
              </li>
              <li>
                <p>Development</p>
                <div class="progressbar line yellow" data-value="85"><svg viewBox="0 0 100 6" preserveAspectRatio="none" style="display: block; width: 100%;"><path d="M 0,3 L 100,3" stroke="#eee" stroke-width="6" fill-opacity="0"></path><path d="M 0,3 L 100,3" stroke="#555" stroke-width="6" fill-opacity="0" style="stroke-dasharray: 100, 100; stroke-dashoffset: 15;"></path></svg><div class="progressbar-text" style="color: inherit; position: absolute; right: 0px; top: -30px; padding: 0px; margin: 0px;">85 %</div></div>
              </li>
              <li>
                <p>Data Analysis</p>
                <div class="progressbar line orange" data-value="90"><svg viewBox="0 0 100 6" preserveAspectRatio="none" style="display: block; width: 100%;"><path d="M 0,3 L 100,3" stroke="#eee" stroke-width="6" fill-opacity="0"></path><path d="M 0,3 L 100,3" stroke="#555" stroke-width="6" fill-opacity="0" style="stroke-dasharray: 100, 100; stroke-dashoffset: 10;"></path></svg><div class="progressbar-text" style="color: inherit; position: absolute; right: 0px; top: -30px; padding: 0px; margin: 0px;">90 %</div></div>
              </li>
            </ul>
            <!-- /.progress-list -->
          </div>
      ...
      <div class="container py-14 py-md-16">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-16 align-items-center">
          ...
          <div class="col-lg-5">
            ...
            <div class="d-flex flex-row">
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409.6 332.7" data-inject-url="https://sandbox.elemisthemes.com/assets/img/icons/lineal/design.svg" class="svg-inject icon-svg icon-svg-sm text-yellow me-4"><path class="lineal-stroke" d="M350.9 54.2H58.7c-6.2.2-11.4-4.7-11.5-10.9S51.8 31.9 58 31.7h292.9c6.2-.2 11.4 4.7 11.5 10.9s-4.7 11.4-10.9 11.5c-.2.1-.4.1-.6.1zM239.8 328.9a11.182 11.182 0 01-10.6-14.8c2.8-8.3 16.2-47.4 25.6-63.6-9.5-10.1-37-40.3-49.9-66.1-12.1 23.4-39.5 54.4-50.1 66 10.1 16.5 22.7 54.9 25.4 63.6.4 1.2.6 2.4.6 3.7 0 6.2-5 11.2-11.2 11.2-4.9 0-9.3-3.2-10.7-7.9v-.1c-6.6-20.7-18.4-52.9-24.3-60.3-4.8-6.1-3.4-14.5-.8-19.8.5-.9 1.1-1.8 1.8-2.6 20.6-22.3 50.7-59.4 52.7-72.4.6-3.7 3.3-10.1 14.8-10.7 12.5-.7 16.6 4.8 17.8 9.4 5.7 21.5 40 60.3 52.7 73.4.8.8 1.5 1.8 2 2.8 2.6 5.1 4 13.3-.5 19.5-5.7 7.7-18.2 41.6-24.8 61.1-1.3 4.6-5.6 7.7-10.5 7.6z"></path><path class="lineal-stroke" d="M204.8 254.9c-6.2 0-11.2-5-11.2-11.2V167c.3-6.2 5.6-10.9 11.8-10.6 5.7.3 10.3 4.9 10.6 10.6v76.7c0 6.2-5 11.2-11.2 11.2z"></path><path class="lineal-stroke" d="M366.6 244.6c-6.2 0-11.2-5-11.2-11.2v-28.6c0-83.1-67.6-150.6-150.6-150.6S54.2 121.7 54.2 204.8v28.6c-.2 6.2-5.4 11.1-11.5 10.9-5.9-.2-10.7-4.9-10.9-10.9v-28.6c-.1-95.5 77.2-172.9 172.7-173 46 0 90.1 18.2 122.6 50.8 32.6 32.3 50.9 76.3 50.9 122.2v28.6c-.1 6.2-5.2 11.2-11.4 11.2z"></path><path class="lineal-fill" d="M220 74.7h-30.4c-9.1 0-16.5-7.4-16.5-16.5V27.7c0-9.1 7.4-16.5 16.5-16.5H220c9.1 0 16.5 7.4 16.5 16.5v30.5c0 9.1-7.4 16.5-16.5 16.5z"></path><path class="lineal-stroke" d="M220 85.9h-30.4c-15.3 0-27.7-12.4-27.7-27.7V27.7c0-15.3 12.4-27.7 27.7-27.7H220c15.3 0 27.7 12.4 27.7 27.7v30.5c0 15.3-12.4 27.7-27.7 27.7zm-30.4-63.5c-2.9 0-5.3 2.4-5.3 5.3v30.5c0 2.9 2.4 5.3 5.3 5.3H220c2.9 0 5.3-2.4 5.3-5.3V27.7c0-2.9-2.4-5.3-5.3-5.3h-30.4z"></path><path class="lineal-fill" d="M381.9 275.4h-30.5c-9.1 0-16.5-7.4-16.5-16.5v-30.5c0-9.1 7.4-16.5 16.5-16.5h30.5c9.1 0 16.5 7.4 16.5 16.5v30.5c0 9.1-7.4 16.5-16.5 16.5z"></path><path class="lineal-stroke" d="M381.9 286.6h-30.5c-15.3 0-27.7-12.4-27.7-27.7v-30.5c0-15.3 12.4-27.7 27.7-27.7h30.5c15.3 0 27.7 12.4 27.7 27.7v30.5c0 15.3-12.4 27.7-27.7 27.7zm-30.5-63.4c-2.9 0-5.3 2.4-5.3 5.3V259c0 2.9 2.4 5.3 5.3 5.3h30.5c2.9 0 5.3-2.4 5.3-5.3v-30.5c0-2.9-2.4-5.3-5.3-5.3h-30.5z"></path><path class="lineal-fill" d="M58.2 275.4H27.7c-9.1 0-16.5-7.4-16.5-16.5v-30.5c0-9.1 7.4-16.5 16.5-16.5h30.5c9.1 0 16.5 7.4 16.5 16.5V259c0 9.1-7.4 16.5-16.5 16.4z"></path><path class="lineal-stroke" d="M58.2 286.6H27.7C12.4 286.6 0 274.2 0 258.9v-30.5c0-15.3 12.4-27.7 27.7-27.7h30.5c15.3 0 27.7 12.4 27.7 27.7v30.5c0 15.3-12.4 27.7-27.7 27.7zm-30.5-63.4c-2.9 0-5.3 2.4-5.3 5.3V259c0 2.9 2.4 5.3 5.3 5.3h30.5c2.9 0 5.3-2.4 5.3-5.3v-30.5c0-2.9-2.4-5.3-5.3-5.3H27.7zm234.1 109.5h-114c-6.2 0-11.2-5-11.2-11.2 0-6.2 5-11.2 11.2-11.2h114c6.2 0 11.2 5 11.2 11.2 0 6.2-5 11.2-11.2 11.2z"></path></svg>
              </div>
              <div>
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
          <div class="col-lg-7 order-lg-2">
            <figure><img class="w-auto" src="/assets/img/illustrations/i2.png" alt=""></figure>
          </div>
          <!--/column -->
          <div class="col-lg-5">
    ...
    <section class="wrapper bg-light">
      <div class="container py-14 py-md-16">
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
          ...
          <!--/column -->
          <div class="col-lg-8">
            <div class="swiper-container text-center mb-6 swiper-container-0" data-margin="30" data-dots="true" data-items-xl="3" data-items-md="2" data-items-xs="1">
              <div class="swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
                <swiper :modules="modules" :allow-touch-move="true" :slides-per-view="3" :space-between="30" :navigation="false" :pagination="{ clickable: true }" class="swiper-wrapper" style="cursor: grab; transform: translate3d(0px, 0px, 0px);" id="swiper-wrapper-4456b284d466b55e" aria-live="off">
                  <swiper-slide class="swiper-slide swiper-slide-active" style="width: 378px; margin-right: 30px;" role="group" aria-label="1 / 5">
                  ...
                  <!--/.swiper-slide -->
                  <swiper-slide class="swiper-slide swiper-slide-next" style="width: 378px; margin-right: 30px;" role="group" aria-label="2 / 5">
                    <img class="rounded-circle w-20 mx-auto mb-4" src="/assets/img/avatars/t2.jpg" alt="">
                  ...
                  <!--/.swiper-slide -->
                  <swiper-slide class="swiper-slide" style="width: 378px; margin-right: 30px;" role="group" aria-label="3 / 5">
