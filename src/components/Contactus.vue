        ...
        <section class="wrapper bg-light angled upper-end">
            <div class="container py-14 py-md-16">
                ...
                <div class="col-lg-7 position-relative">
                    <div class="shape bg-dot primary rellax w-18 h-18" data-rellax-speed="1" style="top: 115px; left: -1.4rem; z-index: 0; transform: translate3d(0px, -128px, 0px);"></div>
                    <div class="row gx-md-5 gy-5">
                    <div class="col-md-6">
                        <figure class="rounded mt-md-10 position-relative"><img src="/assets/img/photos/g5.jpg" alt=""></figure>
                    </div>
                    <!--/column -->
                    <div class="col-md-6">
                        <div class="row gx-md-5 gy-5">
                        <div class="col-md-12 order-md-2">
                            <figure class="rounded"><img src="/assets/img/photos/g6.jpg" alt=""></figure>
                        </div>
                        <!--/column -->
                        <div class="col-md-10">
